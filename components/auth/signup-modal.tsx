...
const SignupModal: React.FC<SignupModalProps> = ({ 
  ...
  const handleBackdropClick = () => {
    ...
    const hasData = formData.email.trim() || formData.username.trim() || 
  ...
  return (
    <Portal>
      <AnimatePresence>
        <div className="modal-overlay overflow-y-auto" style={{ zIndex: 99999 }}>
        {/* Backdrop */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        {/* Modal */}
        <div className="flex min-h-full items-center justify-center p-4 modal-content" style={{ zIndex: 100000 }}>
          <motion.div
            initial={{ opacity: 0, scale: 0.9, y: 50, rotateX: 10 }}
            animate={{ opacity: 1, scale: 1, y: 0, rotateX: 0 }}
            exit={{ opacity: 0, scale: 0.9, y: 50, rotateX: 10 }}
            transition={{ type: "spring", damping: 25, stiffness: 300 }}
            className="relative w-full max-w-md bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl border border-slate-600/50 rounded-3xl shadow-2xl overflow-hidden"
            style={{ zIndex: 100001 }}
          >
            {/* Animated Background Gradient */}
            <div className="absolute inset-0 bg-gradient-to-br from-amber-500/5 via-transparent to-orange-500/5" />
            <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-amber-400/3 to-transparent" />
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              onClick={handleClose}
              className="absolute top-4 right-4 z-50 p-2 text-slate-400 hover:text-white hover:bg-slate-800/50 rounded-full transition-colors"
            >
              <X className="h-5 w-5" />
            </motion.button>
            ...
            <div className="relative bg-gradient-to-r from-amber-500/10 via-orange-500/10 to-amber-500/10 border-b border-amber-500/20 p-6">
              <div className="relative z-10">
                ...
                >
                  ...
                  <p className="text-slate-300 text-sm">Create your account to start typing</p>
                </motion.div>
              </div>
            ...
            {/* Form */}
            <form onSubmit={handleSubmit} className="relative p-6 space-y-5 max-h-[70vh] overflow-y-auto">
              {error && (
                <motion.div
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="relative w-full px-4 py-3 bg-slate-800/60 backdrop-blur-sm border border-slate-600/50 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500/40 focus:border-amber-500/60 focus:bg-slate-800/80 transition-all duration-300 hover:border-slate-500/70"
              ...
              >
                ...
                <div className="relative group">
                  <div className="absolute inset-0 bg-gradient-to-r from-amber-500/20 to-orange-500/20 rounded-xl blur opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  <User className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-slate-400 group-focus-within:text-amber-400 transition-colors duration-200 z-10" />
                  <input
                    type="text"
                    name="username"
